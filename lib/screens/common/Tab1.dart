...
import 'package:talentsearchenglish/screens/common/PodVideoScreen.dart';
import 'package:talentsearchenglish/screens/common/VideoScreen.dart';
...
import 'package:talentsearchenglish/utils/Controllers/ChanneResourcelController.dart';
...
class VideoResourcesTab extends StatefulWidget {
  const VideoResourcesTab({Key? key, required this.channelId})
      : super(key: key);
  final int channelId;
...
class _VideoResourcesTabState extends State<VideoResourcesTab> {
  ChannelResourceController resourceController =
      Get.put(ChannelResourceController());
  Future<bool>? isFetched;
  final RefreshController refreshController = RefreshController();
  @override
  void initState() {
    isFetched =
        resourceController.getChannelVideos(channelId: widget.channelId);
    super.initState();
  }

  void onRefresh() async {
    bool result =
        await resourceController.getChannelVideos(channelId: widget.channelId);
    setState(() {
                          ...
                          child: Padding(
                            ...
                            child: ListView.builder(
                              ...
                              itemCount: resourceController
                                  .liveVideos.length, //data!.videos!.length,
                              itemBuilder: (context, index) {
                                String datetime = parseDateTimeAndSeparate(
                                    resourceController
                                        .liveVideos[index].startDate!);
                                return Padding(
                                  padding:
                                      const EdgeInsets.symmetric(vertical: 8.0),
                                  child: ListTile(
                                    onTap: () {
                                      if (resourceController.liveVideos[index]
                                                  .isStreaming !=
                                              null &&
                                          resourceController
                                        ...
                                        Get.to(() => PodYouTubePlayerScreen(
                                            video:
                                                resourceController.liveVideos[
                                                    index] /*videos[index]*/));
                                      } else {
                                        Get.showSnackbar(const GetSnackBar(
                                          title: "Try Again Later",
                                          message:
                                              "The live video you are trying to play is not streaming right now.",
                                    ...
                                    tileColor:
                                        const Color.fromARGB(255, 30, 112, 106),
                                    ...
                                    leading: Container(
                                      decoration: BoxDecoration(
                                        ...
                                        gradient:
                                            _buildTileGradient(), // Use the custom gradient
                                      ),
                                      child: const Icon(
                      ...
                      Padding(
                        ...
                        child: Padding(
                          ...
                          child: ListView.builder(
                            ...
                            physics: const NeverScrollableScrollPhysics(),
                            itemCount: resourceController
                                .normalVideos.length, //data!.videos!.length,
                            itemBuilder: (context, index) {
                              ...
                              return Padding(
                                ...
                                child: ListTile(
                                  onTap: () {
                                    Get.to(() => PodYouTubePlayerScreen(
                                        video: resourceController.normalVideos[
                                            index] /*videos[index]*/));
                                  },
                                  style: ListTileStyle.list,
                                  enableFeedback: true,
