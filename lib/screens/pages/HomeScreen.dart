                                    ...
                                    if (snapshot.connectionState ==
                                      ...
                                      if (snapshot.data == true) {
                                        if (snapshot.data == false) {
                                          ...
                                          if (homeScreenController.bannersList
                                                      ...
                                                      (index) {
                                                        return GestureDetector(
                                                          onTap: () {
                                                            ...
                                                            _carouselController
                                                                .animateToPage(
                                                                    index); // Change the current image
                                                          },
                                                          child: Obx(
                                                            () => Padding(
                                                              padding:
                                                              ...
                                                              child: Container(
                                                                width:
                                                                    8.0, // Adjust the width of the indicator
                                                                height:
                                                                    8.0, // Adjust the height of the indicator
                                                                margin: const EdgeInsets
                                                                    .symmetric(
                                                                    horizontal:
                                                                        4.0), // Adjust the margin
                                                                decoration:
                                                                    BoxDecoration(
                                                                  shape: BoxShape
                                                                      .circle,
                                                                  color: index ==
                                                                          homeScreenController
                                                                              ...
                                                                              .value
                                                                      ? CustomColors
                                                                          .primaryColorDark // Active indicator color
                                                                      : Colors
                                                                          .grey, // Inactive indicator color
                                                                ),
                                                              ),
                                                            ),
                                                          ),
                          ...
                          builder: (context, snapshot) {
                            if (snapshot.connectionState ==
                              ...
                              if (snapshot.data == false) {
                                return const Center(
                                  child:
                                      Text('Could not obtain channels for you'),
                                );
                              } else {
                                if (homeScreenController
                                    .channelData.value.channels!.isEmpty) {
                                  return SizedBox(
                                      height: Get.height * 0.1,
                                      child: const Center(
                                        child: Text(
                                            'Youi have not subscribed to any channels.'),
                                      ));
                                }
                                    ...
                                    itemBuilder: (context, index) {
                                      return HomeVideoCard(
                                        ...
                                        thumbnailUrl: homeScreenController
                                            ...
                                            .channels![index]
                                            .thumbnail!,
                                        title: homeScreenController.channelData
                                            .value.channels![index].name!,
                                        price: homeScreenController.channelData
                                                .value.channels![index].price ??
                                            0,
                                        avatarUrl:
