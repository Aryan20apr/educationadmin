...
import 'package:talentsearchenglish/utils/Controllers/NoticesController.dart';
                  ...
                  builder: (context, snapshot) {
                    if (snapshot.connectionState == ConnectionState.waiting) {
                      ...
                      if (snapshot.data == false) {
                        return const Center(
                            child: Text('Cannot obtain notices'));
                      } else {
                        ...
                        return ListView.builder(
                              ...
                              child: Obx(
                                () => ExpansionTile(
                                  onExpansionChanged: (value) =>
                                      noticesController.isExpanded[index] =
                                          value,
                                  initiallyExpanded:
                                      noticesController.isExpanded[index],
                                  ...
                                  title: Text(
                                    noticesController.notices.value
                                            .notices![index].title ??
                                        "",
                                    style: TextStyle(
                                      fontSize: 13.sp,
                          ...
                          itemCount:
                              noticesController.notices.value.notices!.length,
                        );
                      }
                    } else {
                      return const Center(child: Text('Some error occurred'));
