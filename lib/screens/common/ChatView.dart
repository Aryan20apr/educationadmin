import 'package:talentsearchenglish/utils/Controllers/ChatController.dart';
                ...
                child: ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      if (index == chatController.chatList.length) {
                        ...
                        return Wrap(
                          alignment: chatController.chatList[index].userName ==
                                  userDetailsManager.username.value
                              ? WrapAlignment.end
                              : WrapAlignment.start,
                          children: [
                            Card(
                              color: chatController.chatList[index].userName ==
                                      userDetailsManager.username.value
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  crossAxisAlignment:
                                      chatController.chatList[index].userName ==
                                              userDetailsManager.username.value
                ...
                return Container(
                  height: isVisible
                      ...
                      : constraints.maxHeight *
                          0.1, //isKeyboardOpen.value ?constraints.maxHeight*0.7:constraints.maxHeight*0.1,
