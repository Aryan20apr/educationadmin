                                                 ...
                                                 decoration: BoxDecoration( shape: BoxShape.rectangle,borderRadius: BorderRadius.all(Radius.circular(20.0))
                                                  ...
                                                  child: Column(
                                                    children: [
                                                      ...
                                                      // Network image
                                                      CachedNetworkImage(imageUrl:'${exploreViewModal.channelData.value.channels![index].thumbnail}',
                                                      ...
                                                      height:  constraints.maxHeight*0.5, width: constraints.maxHeight*0.95,fit: BoxFit.fitWidth,
                                                    ...
                                                    //       ) ,
                                                      ...
                                                      Padding(
                                                        padding: const EdgeInsets.all(10.0),
                                                        child:  Text('Price: ${exploreViewModal.channelData.value.channels![index].price!=0?exploreViewModal.channelData.value.channels![index].price:'Free'}',style: TextStyle(color: Colors.black,fontWeight: FontWeight.w500,fontSize: 15.sp),),
                                                      ),
