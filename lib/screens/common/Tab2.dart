...
class _FileResourcesTabState extends State<FileResourcesTab> {
  ...
  void onRefresh() async {
    bool result =
        await resourceController.getChannelFiles(channelId: widget.channelId);
    setState(() {
    ...
    return SmartRefresher(
      ...
      child: ListView(children: [
        Padding(
          ...
          child: FutureBuilder(
              future: resourceController.getChannelFiles(
              ...
              builder: (context, snapshot) {
                if (snapshot.connectionState == ConnectionState.waiting) {
                  ...
                  if (resourceController.fileData.value.data == null ||
                      resourceController.fileData.value.data!.files!.isEmpty) {
                    return const Center(
                    ...
                    child: Padding(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          FileController fileController = Get.put(
                              FileController(),
                              tag: files![index].link);
                          fileController.checkFileDownloadStatus(
                              filename: files[index].title!,
                              createdAt: files[index].createdAt!);
                          return Padding(
                              padding:
                              ...
                              child: ListTile(
                                ...
                                trailing: Obx(() => (fileController
                                    ...
                                    : IconButton(
                                        onPressed: () {
                                          fileController.isDownloaded.value ==
                                                  false
